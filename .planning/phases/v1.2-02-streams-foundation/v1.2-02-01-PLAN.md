...
- Store state in hidden properties: _state, _reader (null or reader reference), _controller, _queue (array of chunks), _closeRequested, _pulling
...
readable_stream.registerReadableStreamAPI(isolate, context);
```
...
3. Test app passes all 4 tests (see Task 3 verification)
